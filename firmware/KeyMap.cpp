...
const Keymap::Key Keymap::layout[][(int)Matrix::Dim::Row][(int)Matrix::Dim::Col] = {
  [(int)Layer::Base] = {
    ...
    { Key::Cmd,   Key::A,     Key::S,      Key::D,      Key::F,     Key::G,     Key::H,     Key::J,      Key::K,     Key::L,      Key::Semicolon, Key::SQuote,  Key::F6,      Key::F7,          Key::F8 },
    { Key::LShift,     Key::Z,     Key::X,      Key::C,      Key::V,     Key::B,     Key::N,     Key::M,      Key::Comma, Key::Period, Key::Slash,     Key::RShift,  Key::F9,      Key::F10,         Key::F11 },
    { Key::None,       Key::Down, Key::Up, Key::Left,   Key::None,  Key::Right, Key::LBrace,    Key::None,   Key::RBrace,  Key::Grave, Key::Del,    Key::None,    Key::F12,     Key::PrintScrn,   Key::ScrollLock },
    { Key::None,       Key::None,  Key::SR1,    Key::SR2,    Key::None,  Key::Capslock,   Key::SR4,   Key::SR3,    Key::Alt,   Key::None,   Key::None,      Key::None,    Key::Pause,   Key::PG,          Key::KY },
    { Key::None,       Key::None,  Key::None,   Key::SL4,    Key::Esc,   Key::SL6,   Key::SL1,   Key::None,   Key::SL2,   Key::SR5,    Key::None,      Key::None,    Key::None,    Key::None,        Key::None }
  }
};
